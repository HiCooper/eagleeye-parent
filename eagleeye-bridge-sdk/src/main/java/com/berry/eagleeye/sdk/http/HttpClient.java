...
import com.berry.eagleeye.sdk.utils.StringUtils;
import okhttp3.*;
...
public class HttpClient {
    ...
    private static final ConnectionPool pool = new ConnectionPool(CONNECTION_POOL_MAX_IDLE_COUNT, CONNECTION_POOL_MAX_IDLE_MINUTES, TimeUnit.MINUTES);
    ...
    public HttpClient(int timeout) {
        CLIENT = new OkHttpClient.Builder()
                ...
                .readTimeout(timeout * 3L, TimeUnit.SECONDS)
                .dispatcher(dispatcher)
                .connectionPool(pool)
                .build();
    }
     ...
     * @return
     */
    public Response get(String url, StringMap header) throws HttpException {
     ...
     * @return 响应
     */
    public Response get(String url, @Nullable StringMap params, StringMap header) throws HttpException {
        if (params != null) {
     ...
     * @return 响应
     */
    public Response postForm(String url, StringMap params, StringMap headers) throws HttpException {
     ...
     */
    public Response post(String url, String body, StringMap header) throws HttpException {
        return post(url, StringUtils.utf8Bytes(body), header, Constants.JSON_MIME);
    }

    /**
     * 复杂Map（包含字节数组）对象 以 json 格式请求，
     */
    public Response postComplex(String url, StringMap params, StringMap header) throws HttpException {
     ...
     */
    public Response post(String url, byte[] body, StringMap header) throws HttpException {
        return post(url, body, header, Constants.JSON_MIME);
    }

    /**
     * 请求体为 字节数组，指定 媒体类型
     */
    public Response post(String url, byte[] body, StringMap header, String contentType) throws HttpException {
     ...
     * @return 响应
     */
    private static Response post(String url, RequestBody body, StringMap header) throws HttpException {
        Request.Builder requestBuilder = new Request.Builder().url(url).post(body);
        return send(requestBuilder, header);
    }
     ...
     * @return 响应
     */
    private static Response send(final Request.Builder requestBuilder, @Nullable StringMap header) throws HttpException {
        if (header != null) {
    ...
    private static String userAgent() {
        ...
        String sdk = "ELELIBJava/" + Constants.VERSION;
