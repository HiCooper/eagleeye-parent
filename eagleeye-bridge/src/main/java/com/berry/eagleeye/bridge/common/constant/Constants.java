package com.berry.eagleeye.bridge.common.constant;
...
public final class Constants {
    ...
    public static final String REQUEST_SUCCESS_MESSAGE = "操作成功";
     ...
     * sdk 口令前缀
     */
    public static final String BRIDGE_SDK_AUTH_PREFIX = "BRIDGE-";
