package com.berry.eagleeye.bridge.common.utils;
...
public final class Auth {
    ...
    static {
        ACCESS_TOKEN_CAN_REQUEST_API.add("/api/bridge/v.*/submit_approval");
        ACCESS_TOKEN_CAN_REQUEST_API.add("/api/bridge/v.+/get_status");
        ACCESS_TOKEN_CAN_REQUEST_API.add("/api/bridge/v.+/get_result");
    }
    ...
    public static void validRequest(String originAuthorization, String urlString, String accessKeyId, String accessKeySecret) throws IllegalAccessException {
        ...
        String authorization = Constants.BRIDGE_SDK_AUTH_PREFIX + signRequestStr;
